// Shared data: AI tools, GitHub trending, categories, news
// Bilingual (中英双语). All static — meant for design mockup.
...
// Pseudo-realistic AI tools. Logo = 1-2 letter monogram on a brand color.
const AI_TOOLS = [
...
// GitHub trending — repo name, lang color, stars, gained.
// Lang colors are GitHub's actual linguist palette.
const LANG_COLOR = {
...
window.AITB = { CATEGORIES, AI_TOOLS, GITHUB_TRENDING, LANG_COLOR, NEWS };
