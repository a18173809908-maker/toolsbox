...
**但 G4-G7 还一个都没做**，请继续按以下顺序推进，每个独立 commit：
...
G6  E2 Product Hunt 官方 API  ← 需先申请 token
G8  D1 / E4 / E5             ← 最后批，等前面稳定
```

每个任务的具体实施细节见下面对应章节（G4 → 五·七 F2，G7 → 五·五 D3，G5/G6 → 五·六 E2/E3，G8 → 五·五 D1 + 五·六 E4/E5）。
